...
next_id = 1  # El identificador empieza desde el número 1, cada vez que se cree un nuevo producto, se incrementará este número para asignar un nuevo ID único al producto.


@app.get(
    "/products/", response_model=list[ProductResponse], status_code=status.HTTP_200_OK
)
...
def get_product(product_id: int) -> dict:
    ...
    raise HTTPException(
        ...
        detail="El producto solicitado no se encontró",
    )
